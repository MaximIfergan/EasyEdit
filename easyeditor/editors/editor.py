    ...
    def __init__(self,
        ...
        if type(self.model_name) is str:
            if 't5' in self.model_name.lower():
                ...
                self.model = AutoModelForCausalLM.from_pretrained(self.model_name, bf16=True if hparams.alg_name == 'ROME' else False ,trust_remote_code=True, device_map='auto' if hparams.model_parallel else None)
